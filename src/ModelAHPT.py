...
def metricsToFile():
    ...
    df.to_csv("metrics_file_AHPT.txt",index=False,header = False)

# FUNCTION THAT DEFINES MODEL STRUCTURE :

# HyperParameterTuning revealed that the following structure was better and hence the model will be created as follows
# Creates the model as follows:
# 16 attributes ->     [18 neurons]     ->     [14 neurons]     ->     [28 neurons]      ->     [10 neurons]      ->     [20 neurons]      ->    7 outputs
...
def main():
    ...
    trained_model.save('AHPTtrainedNNmodel.h5')                                                     # Saving trained file for hyperparameter Tuning and backend deployment
